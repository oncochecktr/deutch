/** Marka ve sınav genellemesi — Goethe, TELC, ÖSD, DTZ vb. */

export const APP_NAME = "German Coach";
export const APP_TAGLINE = "Almanya A1 hazırlık";
export const APP_VERSION = "v0.8";

export const EXAM_PROVIDERS = ["Goethe", "TELC", "ÖSD", "DTZ"] as const;
