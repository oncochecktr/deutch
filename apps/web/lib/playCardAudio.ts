...
/** Kelime karti: Almanca N kez + istege bagli Turkce cevirisi */
export async function playCardWordAudio(
  word: VocabularyWord,
  settings: Pick<CardsListenSettings, "speechSpeed" | "repeatCount" | "playTranslation">
): Promise<void> {
