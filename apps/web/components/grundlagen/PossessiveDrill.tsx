...
import type { PossessiveDrill as PossessiveDrillItem } from "@/lib/grundlagen";

interface PossessiveDrillProps {
  drills: PossessiveDrillItem[];
  onFinish: (correct: number) => void;
}

export function PossessiveDrillPanel({ drills, onFinish }: PossessiveDrillProps) {
  ...
  return (
    <div className="card-soft space-y-4 p-5">
      <div className="flex items-center justify-between">
        <p className="text-xs font-semibold uppercase text-goethe-blue">Possessiv drill</p>
