...
export function ContinueLearningPageClient() {
  const { report, srs, smartQueue, progress, a1, mesleki } = useDashboardReport();
      ...
      <div className="space-y-6">
        <header className="space-y-3">
          ...
          <div>
            ...
            <h1 className="mt-1 text-2xl font-extrabold text-goethe-blue sm:text-3xl">
              Bugünkü yolunu tek ekranda gör
            </h1>
            <p className="mt-2 max-w-2xl text-sm leading-6 text-sage-500">
              Hikaye, oyun, tekrar, koçluk ve günlük sıra burada toplanır. Ana sayfa sakin kalır;
              çalışma akışı bu ekrandan yürür.
            </p>
          </div>
        </header>
