      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="min-w-0 flex-1">
          ...
          <ul className="mt-3 space-y-1.5 text-xs text-sage-600">
            <li>
              <span className="font-semibold text-goethe-blue">Dinle</span>
              <span className="text-sage-500"> — önce Almanca, sonra Türkçe</span>
            </li>
            <li>
              <span className="font-semibold text-goethe-blue">Yaz</span>
              <span className="text-sage-500"> — duyduğunu kontrol et</span>
            </li>
            <li>
              <span className="font-semibold text-goethe-blue">Öğren</span>
              <span className="text-sage-500"> — ekran kilitli · kulaklık düğmeleri</span>
            </li>
          </ul>
        </div>
